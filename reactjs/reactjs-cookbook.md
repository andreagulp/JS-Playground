...
## Table of Content
- [Reactjs Cookbook](#reactjs-cookbook)
  * [Way to update an item in a list array](#way-to-update-an-item-in-a-list-array)
  * [Install and import mutability-helper](#install-and-import-mutability-helper)
  * [Javascript CRUD operations and associated immutability-helper commands](#javascript-crud-operations-and-associated-immutability-helper-commands)
  * [Add, Delete items to / from an array and store in in the locak storage](#add--delete-items-to---from-an-array-and-store-in-in-the-locak-storage)
  * [Command line - delete files](#command-line---delete-files)
  * [Command line - Create Folder](#command-line---create-folder)
  * [Command line - create files](#command-line---create-files)
  * [datatime formatting with momentjs](#datatime-formatting-with-momentjs)
  * [Conditional render jsx with inline if](#conditional-render-jsx-with-inline-if)
  * [Call APi with axios and make statistical calculation and store them in a new array](#call-api-with-axios-and-make-statistical-calculation-and-store-them-in-a-new-array)
  * [Use Filter to count category](#use-filter-to-count-category)
  * [Use a defulat value for input field](#use-a-defulat-value-for-input-field)
  * [Clear Input field with react-bootstrap <formControl>](#clear-input-field-with-react-bootstrap--formcontrol-)
  * [Import Material UI for react (http://www.material-ui.com)](#import-material-ui-for-react--http---wwwmaterial-uicom-)
  * [Call Api with axios and set to an array in this.state](#call-api-with-axios-and-set-to-an-array-in-thisstate)
  * [Component, PureComponent, Stateless functional Component](#component--purecomponent--stateless-functional-component)
  * [Basic Search in a list of items](#basic-search-in-a-list-of-items)
  * [Clean Input Field](#clean-input-field)
  * [Dynamic link in img](#dynamic-link-in-img)
  * [Delete item from array with onClick event](#delete-item-from-array-with-onclick-event)
  * [Tutorials](#tutorials)
  * [Implement Local Storage](#implement-local-storage)
  * [Import bootstrap 3, theme, fonteawesome Method 1](#import-bootstrap-3--theme--fonteawesome-method-1)
  * [Import bootstrap and jquery Method 2 (using require)](#import-bootstrap-and-jquery-method-2--using-require-)
  * [Use create-react-app command](#use-create-react-app-command)
  * [Import external library](#import-external-library)
  * [render an array of items with .map](#render-an-array-of-items-with-map)
  * [Bind 1 Input Field with onChange](#bind-1-input-field-with-onchange)
  * [Bind and add multiple input field with onChange + clear field](#bind-and-add-multiple-input-field-with-onchange---clear-field)
  * [Add element to Array](#add-element-to-array)
  * [Add multiple inputs field to an array of object using refs](#add-multiple-inputs-field-to-an-array-of-object-using-refs)
